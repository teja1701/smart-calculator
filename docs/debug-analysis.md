...
The variable sum was incorrectly initialised to 1 instead of 0, artificially inflating the total calculation. This was identified by tracing the execution and discovering the accumulator started with a pre-existing value.
